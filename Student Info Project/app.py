...
db_config = {
    'host': 'localhost',  # The address where the database is located
    'user': 'root',       # The username to log in to the database
    'password': 'sarvo1234',  # The password to log in to the database
    'database': 'sarvo'   # The name of the database we are using
}
